...
export const users = pgTable("users", {
  ...
  verifyOtp: varchar("verify_otp", { length: 255 }),
  verifyOtpExpiredAt: timestamp("verify_otp_expired_at", { withTimezone: true }),
  resetOtp: varchar("reset_otp", { length: 255 }),
  resetOtpExpiredAt: timestamp("reset_otp_expired_at", { withTimezone: true }),

  isAccountVerified: boolean("is_account_verified").notNull().default(false),
  // prefer snake_case for DB column
