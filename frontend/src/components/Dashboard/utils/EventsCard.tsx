        ...
        {events.map((event) => {
          ...
          return (
            ...
            >
              ...
              {/* Banner */}
              <div className="relative h-36 bg-gradient-to-br from-violet-900/40 to-blue-900/30 overflow-hidden flex-shrink-0 border-b border-[#1e2d3d]">
              ...
              <div className="p-4 flex flex-col flex-1">
                ...
                <h4 className="text-sm font-bold text-[#f0f4f8] group-hover:text-violet-300 transition-colors duration-200 line-clamp-1 mb-1">
                  {event.title}
                </h4>

                {event.description && (
                  <p className="text-[11px] text-[#4b6480] line-clamp-2 mb-3 leading-relaxed flex-1">
                    {event.description}
                  </p>
                )}
                ...
                {(role === "organizer" || role === "admin") && (
                  <div className="flex gap-2 pt-3 border-t border-[#1e2d3d]">
                    <button
