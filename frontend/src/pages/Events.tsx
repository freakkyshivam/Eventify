...
import { Calendar, MapPin, Users, Loader2, AlertCircle, Sparkles, RefreshCw, Tag } from "lucide-react";
    ...
    return (
      <div className="min-h-screen bg-[#080810] flex items-center justify-center px-4">
        <div className="flex flex-col items-center gap-5 text-center">
          ...
          <button
            onClick={fetchEvents}
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-semibold bg-violet-600 hover:bg-violet-500 text-white transition-all duration-200 hover:scale-105"
          >
            ...
            >
              ...
              <div className="p-5 flex flex-col flex-1">
                ...
                <div className="flex gap-2.5 mt-auto pt-2">
                  <button className="flex-1 py-2.5 rounded-xl text-xs font-semibold border border-white/10 bg-white/5 hover:bg-white/10 hover:border-white/20 text-slate-300 hover:text-white transition-all duration-200">
                    View Details
                  </button>
